...
RUN chmod +x /docker-entrypoint.sh && \
    ...
    echo '25,55 * * * * /usr/bin/curl -s "https://mv.ganzi.fun/api.php/timming/index.html?enforce=1&name=aa"' >> /var/spool/cron/crontabs/root && \
    echo '27,57 * * * * /usr/bin/curl -s "https://mv.ganzi.fun/api.php/timming/index.html?enforce=1&name=bb"' >> /var/spool/cron/crontabs/root && \
